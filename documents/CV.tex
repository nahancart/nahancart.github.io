...
\entry{\textbf{The (No) Value of Commitment}, \newline
 I provide a sufficient conditions under which a principal does not benefit from commitment in general economic problems. I then apply this condition in a mechanism design setting. A designer does not benefit from being able to contract over actions when his preferences are partially aligned with the agent. Verifying the condition does not necessitate verifying explicitly that the strategy under commitment is a best-response to the information revealed in the economic problem. }
...
\entry{Nominated to Inspiring Teaching Delivery, Student Choice Award, UCL\hfill \datestamp{2020}{06}{}
}
...
\entry{Student Representative for PhD students at the Economics Department \hfill \datestamp{2017}{}{} -- 2022
}%
...
\firstentry{International Conference on Game Theory (Stony Brook, 2022), Brown-bag theory seminar UCL (2022, 2021), World Congress Game Theory Society (Budapest, 2021), Applied Theory Workshop (Toulouse School of Economics, 2020)}
